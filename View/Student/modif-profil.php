    ...
    <details id="target-me">
      ...
      <form  enctype="multipart/form-data" action="../../Controllers/Users/user/userController.php" method="post" >
        <table>
          ...
          <input type="hidden" name="user_photo" value="<?php echo $_SESSION['infoUser']['user_photo'];?>">
          <tr>
            <td>Last Name</td>
          ...
          <tr>
            ...
            <input type="hidden" name="user_diplome" value="<?php echo $_SESSION['infoUser']['user_diplome'];?>">
